...
export async function main(params) {
  ...
  try {
    ...
    return json(200, { articles: sortArticles(filtered), visibleArticles: filterVisibleArticles(filtered) });
  } catch (error) {
    logger.error('list-articles failed', { message: error.message });
    return json(500, { error: 'Failed to list articles' });
  }
}
