...
// MODULE: ./node_modules/react-dom/cjs/react-dom-client.production.js
var react_dom_client_production_namespaceFn = /*#__PURE__*/__webpack_require__.cw(function(module, exports) {
...
var Scheduler = scheduler_namespaceFn(),
  React = react_namespaceFn(),
  ReactDOM = react_dom_namespaceFn();
...
__webpack_unused_export__ = "19.2.8";

});

// MODULE: ./node_modules/react-dom/cjs/react-dom.production.js
var react_dom_production_namespaceFn = /*#__PURE__*/__webpack_require__.cw(function(module, exports) {
/**
 * @license React
...
if (true) {
  ...
  checkDCE();
  module.exports = react_dom_client_production_namespaceFn();
...
var react_dom_namespaceFn = /*#__PURE__*/__webpack_require__.cw(function(module, exports) {
...
if (true) {
  ...
  // DevTools can report bad minification during injection.
  checkDCE();
  module.exports = react_dom_production_namespaceFn();
} else // removed by dead control flow
{}

});

// MODULE: ./node_modules/react/cjs/react.production.js
var react_production_namespaceFn = /*#__PURE__*/__webpack_require__.cw(function(module, exports) {
/**
 * @license React
 * react.production.js
 *
...
var react_namespaceFn = /*#__PURE__*/__webpack_require__.cw(function(module, exports) {


if (true) {
  module.exports = react_production_namespaceFn();
} else // removed by dead control flow
{}

});

// MODULE: ./node_modules/scheduler/cjs/scheduler.production.js
var scheduler_production_namespaceFn = /*#__PURE__*/__webpack_require__.cw(function(module, exports) {
/**
 * @license React
...
var scheduler_namespaceFn = /*#__PURE__*/__webpack_require__.cw(function(module, exports) {


if (true) {
  module.exports = scheduler_production_namespaceFn();
} else // removed by dead control flow
{}
...
;// ./src/commerce-extensibility-1/admin/App.jsx
...
function h(tag, props, ...children) {
  return (react_production_namespaceFn().createElement)(tag, props, ...children);
}
...
function App() {
  const [articles, setArticles] = (0,react_production_namespaceFn().useState)([]);
  const [search, setSearch] = (0,react_production_namespaceFn().useState)('');
  const [status, setStatus] = (0,react_production_namespaceFn().useState)('all');
  const [selected, setSelected] = (0,react_production_namespaceFn().useState)({});
  const [form, setForm] = (0,react_production_namespaceFn().useState)(emptyForm);

  (0,react_production_namespaceFn().useEffect)(() => {
    setArticles([]);
  }, []);

  const filtered = (0,react_production_namespaceFn().useMemo)(() => articles.filter((row) => rowMatches(row, search) && (status === 'all' ? true : row.visibility === status)), [articles, search, status]);
  ...
  return h(
    ...
    h(
      ...
      h(
        'select',
        { 'aria-label': 'Status filter', value: status, onChange: (e) => setStatus(e.target.value) },
        h('option', { value: 'all' }, 'All'),
        h('option', { value: 'visible' }, 'Visible'),
    ...
    h(
      ...
      filtered.length
        ? filtered.map((row) => h('article', { key: row.id }, h('input', { type: 'checkbox', checked: Boolean(selected[row.id]), onChange: () => setSelected({ ...selected, [row.id]: !selected[row.id] }) }), h('strong', null, row.title)))
...
;// ./src/commerce-extensibility-1/admin/main.jsx




const main_root = (0,react_dom_client_production_namespaceFn().createRoot)(document.getElementById('root'));
main_root.render((react_production_namespaceFn().createElement)(App));
